...
(function() {
  ...
  function updateMetaBtn() {
    ...
    if (label) label.textContent = bmed ? 'Saved' : 'Bookmark';
  }
...
(function() {
  function insertReadingTime() {
    ...
    message.innerHTML = '<span style="display:inline-block;border:1px solid #999;color:#999;font-size:90%;padding:1px 5px;border-radius:3px;line-height:1.4;">PR</span><span><i class="fa-solid fa-hourglass-half"></i> Approx.' + minutes + 'read.</span>';
