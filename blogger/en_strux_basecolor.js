  ...
  },
{
  ...
  light: {
    ...
    "--tab-text-muted": "#fed7e2",
    "--tab-lamp-color": "#92bea2",
    "--tab-border-color": "#e6dacb",
  },
  dark: {
    "--bg-color": "#201712",
    "--text-main": "#fcf6f2",
    ...
    "--bq-bg": "#3d2f28",
    "--bq-border": "#cd8c42",
    "--tab-text-active": "#fcf6f2",
    "--tab-text-muted": "#826e65",
    "--tab-lamp-color": "#92bea2",
    "--tab-border-color": "#4d3a31",
  },
},
];
...
function renderPagination() {
  ...
  html += '<span class="tp-page-info">' + start + '–' + end + ' / ' + themes.length + ' Theme</span>';
...
if (copyBtn) {
  copyBtn.addEventListener('click', function() {
    ...
    var done = function() {
      self.textContent = 'Copying complete ✓';
