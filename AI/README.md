...
## 🌐 Live Demo & Digital Garden
本リポジトリの実装は、以下のサイトで実際に稼働・テストされています。
**[https://blogger.matsusanjpn.com/](https://blogger.matsusanjpn.com/)**
...
※ English version of principles: [English Principles Directory](./principles/)
...
- **[GSAPヒーロースライダー](./patterns/blogger-gsap-slider.md):** ブログの第一印象を決定づける、滑らかでモダンな視覚演出。

---

## ⚙️ 活用方法
1. **PrinciplesをAIに読み込ませる:** LLM（ChatGPTやGemini等）に `principles/` の内容を学習させることで、私の好みにパーソナライズされたコード生成が可能になります。
2. **Patternsを適用する:** 各Markdown内のコードをBloggerのHTML編集画面、またはガジェットに追加してください。

## ✍️ Author
**まつさん**
- **Digital Garden:** [blogger.matsusanjpn.com](https://blogger.matsusanjpn.com/)
- **Philosophy:** Bloggerの可能性を掘り下げる、自称「Blogger=デジタルガーデン庭師」。「AIの限界は、自分の言語化の限界と同じ場所にある」を信条に、日々新しい体験を育て続けています。
...
## 🌐 Live Demo & Digital Garden
The implementations in this repository are actively deployed and tested at:
**[https://blogger.matsusanjpn.com/](https://blogger.matsusanjpn.com/)**
...
- **[GSAP Hero Slider](./patterns/blogger-gsap-slider.md):** Smooth, modern visual effects that define the blog's first impression.
...
**Matsusan**
- **Digital Garden:** [blogger.matsusanjpn.com](https://blogger.matsusanjpn.com/)
- **Philosophy:** A self-proclaimed "Blogger Digital Garden Architect" exploring the hidden potential of the platform. Guided by the belief that "The limits of AI are found at the same place as the limits of one's own verbalization."
